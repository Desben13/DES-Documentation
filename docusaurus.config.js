...
const config = {
  title: 'DES',
  tagline: 'Desben Elevation Solution Documentation',
  favicon: 'newDESlogo.ico',
    ...
    ({
      ...
      navbar: {
        ...
        items: [
          ...
          {
            href: 'https://discord.gg/invite/cha8rRPqqF',
            label: 'Discord',
            position: 'right',
          },
        ],
      ...
      footer: {
        ...
        copyright: `Copyright © ${new Date().getFullYear()} Desben Elevation Solutions`,
      },
      prism: {
